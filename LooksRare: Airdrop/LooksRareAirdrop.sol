...
contract LooksRareAirdrop is Pausable, ReentrancyGuard, Ownable {
    ...
    function claim(
        ...
        // Checks on orders
        require(
            _isOrderMatchingRequirements(makerAsk),
        ...
        if (isERC721) {
            require(
                IERC721(makerAsk.collection).isApprovedForAll(
                    msg.sender,
            ...
            require(
                IERC1155(makerAsk.collection).isApprovedForAll(
                    msg.sender,
     ...
     * @param makerAsk makerAsk order
     */
    function _isOrderMatchingRequirements(
        OrderTypes.MakerOrder calldata makerAsk
